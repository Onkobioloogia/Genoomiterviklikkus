...
```{r}
knitr::include_graphics("assets/img/CRCstages.jpg")
```
...
<img src="http://www.nature.com/nrm/journal/v15/n1/images_article/nrm3721-f1.jpg" )>
...
```{r}
knitr::include_graphics("assets/img/LRCmod.jpg.png")
```
...
```{r}
knitr::include_graphics("assets/img/MMR.png")
```
...
```{r}
knitr::include_graphics("assets/img/Deamination of Bases.JPG")
```
...
```{r}
knitr::include_graphics("assets/img/oxidation.png")
```
...
```{r}
knitr::include_graphics("assets/img/BER.png")
```
...
```{r}
knitr::include_graphics("assets/img/NER.png")
```
